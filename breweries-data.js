const breweriesByState = {
  ...
  "Colorado": ["Busey Brews Smokehouse & Brewery","Gilded Goat Brewing Company","Grimm Brothers","MainStage Brewing Company","MainStage Brewing Company - Gunbarrel","Otherwise Brewing","Peculier Brewing Co","River North Brewery - North Taproom","River North Brewery - RiNo Taproom","Salida Brewing Company","San Luis Valley Brewing Company","Wanderment Brewing","Westminster Brewing Company"],
  "Connecticut": ["Greenwich Brewing Company","Hops on the Hill Brewery","Twelvenote Brew Co"],
  "Delaware": [],
  "Florida": ["Cayo Hueso Brewing","Coastal Dayz Brewery","Good Liquid Brewery","GREAT CHICAGO FIRE BREWERY","Lake Tribe Brewing","Mocama Beer Company"],
  ...
  "Massachusetts": ["Aquatic Brewing","Arcpoint Brewing Company","Element Brewing & Distilling","Fieldcrest Brewing Company","Vanished Valley Brewing"],
  ...
  "New York": ["Abandon Brewing Company","Active Ingredient Brewing Company","Apex Brewery","Argyle Brewing Company","Battle Hill Brewing Company","Catskill Brewery","Bitters & Bones","Dancing Grain Farm Brewery","Gardiner Brewing Company","Simple Brewing","Singlecut Beersmiths","Six Harbors Brewimg Company","South Shore Craft Brewery","Take Two Brewery","The Ridge West Seneca","Twisted Rail Brewing Company - Canandaigua","Twisted Rail Brewing Company - Geneva","Twisted Rail Brewing Company - Honeoye","Twisted Rail Brewing Company - Manchester"],
  "North Carolina": ["Bite My Cookies Brewing Company","Eleven Lakes Brewing Company","Flying Bull Restaurant and Brewery","NC Beer Factory","Red Buffalo Brewing Company"],
  "North Dakota": ["Black Paws Brewing Company","Dialectic Brewing & Ciderhouse"],
  "Ohio": ["Brighten Brew Co.","Combustion Brewery & Taproom - Clintonville","Combustion Brewery & Taproom - Pickerington","ESP Brewing Company","Findlay Brewing Company","Hearth Brewing","Honest Friend Brewing","Muskellunge Brewing Company","North High Brewing Dublin","North High Brewing Westerville","Sons of Toil Brewing LLC","Twin Oast Brewing"],
  ...
  "West Virginia": [],
  "Wisconsin": ["Duesterbeck's Brewing Company","Fifth Ward Brewing Company","Fond du Lac Beer Company","Herbiery Brewing","Knuth Brewing Company","Lakefront Brewery","Lion's Tail Brewing Co. - Nenah","Lion's Tail Brewing Co. - Wauwatosa","McFleshman's Brewing Company","New Denmark Brewing Company","Rowland's Calumet Brewing","Sand Creek Brewing Company","Stubborn Brothers Brewery","Stillmank Brewing Co.","The Grumpy Troll"],
  "Wyoming": []
};
